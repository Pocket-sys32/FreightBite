...
import { MapPin, CheckCircle2, Snowflake, Package, Loader2 } from "lucide-react"
      ...
      <div className="p-5 flex flex-col gap-4">
        ...
        {showAccept && !accepted && leg.status === "OPEN" && (
          <button
            ...
            className="w-full rounded-2xl bg-success text-success-foreground font-bold text-base py-4 min-h-[56px] active:scale-[0.98] transition-transform disabled:opacity-70 flex items-center justify-center gap-2"
          >
            {acceptLoading ? (
              <>
